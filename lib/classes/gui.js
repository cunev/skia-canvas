...
class Window extends EventEmitter {
  ...
  static #kwargs =
    "id,left,top,width,height,title,page,background,fullscreen,cursor,fit,visible,resizable".split(
      /,/
    );
  static #nextID = 1;
  #canvas;
  ...
  constructor(width = 512, height = 512, opts = {}) {
    ...
    let canvas =
      opts.canvas instanceof Canvas ? opts.canvas : new Canvas(width, height);
  ...
  get exclusive() {
    return this.#state.exclusiveFullscreen;
  }
  set exclusive(flag) {
    this.#state.exclusiveFullscreen = flag;
  }
